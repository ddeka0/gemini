...
class MathRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mathlib.MathRequest) */ {
 public:
  MathRequest();
  virtual ~MathRequest();
...
class MathReply final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mathlib.MathReply) */ {
 public:
  MathReply();
  virtual ~MathReply();
