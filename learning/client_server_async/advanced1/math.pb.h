...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_math_2eproto 
...
namespace google {
namespace protobuf {
template<> ::mathlib::MathReply* Arena::CreateMaybeMessage<::mathlib::MathReply>(Arena*);
template<> ::mathlib::MathRequest* Arena::CreateMaybeMessage<::mathlib::MathRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace mathlib {
...
class MathRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mathlib.MathRequest) */ {
 public:
  MathRequest();
  virtual ~MathRequest();
  ...
  // @@protoc_insertion_point(class_scope:mathlib.MathRequest)
 private:
...
class MathReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mathlib.MathReply) */ {
 public:
  MathReply();
  virtual ~MathReply();
  ...
  // @@protoc_insertion_point(class_scope:mathlib.MathReply)
 private:
...
inline ::google::protobuf::int32 MathRequest::a() const {
  // @@protoc_insertion_point(field_get:mathlib.MathRequest.a)
  return a_;
}
inline void MathRequest::set_a(::google::protobuf::int32 value) {
  
  a_ = value;
  // @@protoc_insertion_point(field_set:mathlib.MathRequest.a)
}
...
inline ::google::protobuf::int32 MathRequest::b() const {
  // @@protoc_insertion_point(field_get:mathlib.MathRequest.b)
  return b_;
}
inline void MathRequest::set_b(::google::protobuf::int32 value) {
  
  b_ = value;
  // @@protoc_insertion_point(field_set:mathlib.MathRequest.b)
}
...
inline ::google::protobuf::int32 MathReply::result() const {
  // @@protoc_insertion_point(field_get:mathlib.MathReply.result)
  return result_;
}
inline void MathReply::set_result(::google::protobuf::int32 value) {
  
  result_ = value;
  // @@protoc_insertion_point(field_set:mathlib.MathReply.result)
}
